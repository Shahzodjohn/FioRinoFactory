...
///
/// generated by SPToCore on 09/03/2021 17:08:29
///
...
namespace FioRinoFactory.Model
{
    ...
    {
        private DbSet<EXPOSE_dm_DetailProductListStanMagazynuResult> EXPOSE_dm_DetailProductListStanMagazynu { get; set; }
        private DbSet<EXPOSE_dm_ListOfWzOrders_InWZMAGAZYNResult> EXPOSE_dm_ListOfWzOrders_InWZMAGAZYN { get; set; }
        private DbSet<EXPOSE_dm_OpenningTheSpecificOrderResult> EXPOSE_dm_OpenningTheSpecificOrder { get; set; }
        private DbSet<EXPOSE_dm_OrderDetailResult> EXPOSE_dm_OrderDetail { get; set; }
        private DbSet<EXPOSE_dm_Personal_WzDetailsResult> EXPOSE_dm_Personal_WzDetails { get; set; }
        private DbSet<EXPOSE_dm_SearchingByNameCategoryAndSizeResult> EXPOSE_dm_SearchingByNameCategoryAndSize { get; set; }
        private DbSet<EXPOSE_dm_Selecting_All_NewOrdersResult> EXPOSE_dm_Selecting_All_NewOrders { get; set; }
        private DbSet<EXPOSE_dm_SelectingALLFormAchievumResult> EXPOSE_dm_SelectingALLFormAchievum { get; set; }
        private DbSet<EXPOSE_dm_SelectingCurrentOrderByStatusResult> EXPOSE_dm_SelectingCurrentOrderByStatus { get; set; }
        private DbSet<EXPOSE_dm_SelectingProductGtinResult> EXPOSE_dm_SelectingProductGtin { get; set; }
        private DbSet<EXPOSE_dm_SelectingProductsAfterScanningResult> EXPOSE_dm_SelectingProductsAfterScanning { get; set; }
        ...
        {            
            // No key            
            modelBuilder.Entity<EXPOSE_dm_DetailProductListStanMagazynuResult>().HasNoKey();
            modelBuilder.Entity<EXPOSE_dm_ListOfWzOrders_InWZMAGAZYNResult>().HasNoKey();
            modelBuilder.Entity<EXPOSE_dm_OpenningTheSpecificOrderResult>().HasNoKey();
            modelBuilder.Entity<EXPOSE_dm_OrderDetailResult>().HasNoKey();
            modelBuilder.Entity<EXPOSE_dm_Personal_WzDetailsResult>().HasNoKey();
            modelBuilder.Entity<EXPOSE_dm_SearchingByNameCategoryAndSizeResult>().HasNoKey();
            modelBuilder.Entity<EXPOSE_dm_Selecting_All_NewOrdersResult>().HasNoKey();
            modelBuilder.Entity<EXPOSE_dm_SelectingALLFormAchievumResult>().HasNoKey();
            modelBuilder.Entity<EXPOSE_dm_SelectingCurrentOrderByStatusResult>().HasNoKey();
            modelBuilder.Entity<EXPOSE_dm_SelectingProductGtinResult>().HasNoKey();
            modelBuilder.Entity<EXPOSE_dm_SelectingProductsAfterScanningResult>().HasNoKey();
        ...
        public void EXPOSE_dm_AddingToArchievum_And_DeletingFrom_WZmagazyn(int? WzMagazynId)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_AddingToArchievum_And_DeletingFrom_WZmagazyn] @WzMagazynId";
                //Execution
        ...
        public void EXPOSE_dm_CreateOrder(DateTime? CraeteAt,DateTime? UpdatedAt,int? CategoryId,int? OrderStatusId,int? FileWzId,int? SizeId,bool? Is_removed,DateTime? ImplementationDate,int? Amount,string SourceOfOrder,int? SenderId,int? ProductId)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_CreateOrder] @CraeteAt, @UpdatedAt, @CategoryId, @OrderStatusId, @FileWzId, @SizeId, @Is_removed, @ImplementationDate, @Amount, @SourceOfOrder, @SenderId, @ProductId";
                //Execution
        ...
        public void EXPOSE_dm_CreatingProductByFilling(string SKUnumber,string ProductName,int? SizeId,int? Amount,string Gtin,int? CategoryId)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_CreatingProductByFilling] @SKUnumber, @ProductName, @SizeId, @Amount, @Gtin, @CategoryId";
                //Execution
        ...
        public void EXPOSE_dm_deletingAfterZapizWz(int? OrderId)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_deletingAfterZapizWz] @OrderId";
                //Execution
        ...
        public async Task<List<EXPOSE_dm_DetailProductListStanMagazynuResult>> EXPOSE_dm_DetailProductListStanMagazynuAsync(int? ProductId)
        {
            //Initialize Result 
            List<EXPOSE_dm_DetailProductListStanMagazynuResult> lst = new List<EXPOSE_dm_DetailProductListStanMagazynuResult>();
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_DetailProductListStanMagazynu] @ProductId";
                
                //Output Data
                lst = await this.EXPOSE_dm_DetailProductListStanMagazynu.FromSqlRaw(sqlQuery , p_ProductId ).ToListAsync();

            //Return
            return lst;
        }

        public void EXPOSE_dm_DownloadingANewWzDocumentIfNoNewOrders(string FileName,int? Filetype,decimal? FileSize,int? UserId,ref int? Id)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_DownloadingANewWzDocumentIfNoNewOrders] @FileName, @Filetype, @FileSize, @UserId, @Id OUTPUT";
                //Execution
        ...
        public void EXPOSE_dm_INSERT_Order_To_OrderProducts(int? OrderId)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_INSERT_Order_To_OrderProducts] @OrderId";
                //Execution
                this.Database.ExecuteSqlRaw(sqlQuery , p_OrderId );
        ...
        public void EXPOSE_dm_InsertingOrderIdProductsId(int? OrderId,int? ProductId,int? Amount,int? SizeId,int? ProductStatusId,int? SenderId,int? RecieverId,bool? is_removed,int? WzMagazynId)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_InsertingOrderIdProductsId] @OrderId, @ProductId, @Amount, @SizeId, @ProductStatusId, @SenderId, @RecieverId, @is_removed, @WzMagazynId";
                //Execution
                this.Database.ExecuteSqlRaw(sqlQuery , p_OrderId , p_ProductId , p_Amount , p_SizeId , p_ProductStatusId , p_SenderId , p_RecieverId , p_is_removed , p_WzMagazynId );

            //Return
        }

        public async Task<List<EXPOSE_dm_ListOfWzOrders_InWZMAGAZYNResult>> EXPOSE_dm_ListOfWzOrders_InWZMAGAZYNAsync(int? WzMagazynId)
        {
            //Initialize Result 
            List<EXPOSE_dm_ListOfWzOrders_InWZMAGAZYNResult> lst = new List<EXPOSE_dm_ListOfWzOrders_InWZMAGAZYNResult>();
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_ListOfWzOrders_InWZMAGAZYN] @WzMagazynId";
                
                //Output Data
                lst = await this.EXPOSE_dm_ListOfWzOrders_InWZMAGAZYN.FromSqlRaw(sqlQuery , p_WzMagazynId ).ToListAsync();

            //Return
            return lst;
        }

        public void EXPOSE_dm_MinusingTheProductAmountInStanMagazynu(int? WzMagazynId,int? Amount)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_MinusingTheProductAmountInStanMagazynu] @WzMagazynId, @Amount";
                //Execution
        ...
        public async Task<List<EXPOSE_dm_OpenningTheSpecificOrderResult>> EXPOSE_dm_OpenningTheSpecificOrderAsync(int? OrderId)
        {
            //Initialize Result 
            List<EXPOSE_dm_OpenningTheSpecificOrderResult> lst = new List<EXPOSE_dm_OpenningTheSpecificOrderResult>();
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_OpenningTheSpecificOrder] @OrderId";
                
                //Output Data
                lst = await this.EXPOSE_dm_OpenningTheSpecificOrder.FromSqlRaw(sqlQuery , p_OrderId ).ToListAsync();

            //Return
            return lst;
        }

        public async Task<List<EXPOSE_dm_OrderDetailResult>> EXPOSE_dm_OrderDetailAsync(int? OrderId)
        {
            //Initialize Result 
            List<EXPOSE_dm_OrderDetailResult> lst = new List<EXPOSE_dm_OrderDetailResult>();
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_OrderDetail] @OrderId";
                
                //Output Data
                lst = await this.EXPOSE_dm_OrderDetail.FromSqlRaw(sqlQuery , p_OrderId ).ToListAsync();

            //Return
            return lst;
        }

        public async Task<List<EXPOSE_dm_Personal_WzDetailsResult>> EXPOSE_dm_Personal_WzDetailsAsync(int? OrderId)
        {
            //Initialize Result 
            List<EXPOSE_dm_Personal_WzDetailsResult> lst = new List<EXPOSE_dm_Personal_WzDetailsResult>();
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_Personal_WzDetails] @OrderId";
                
                //Output Data
                lst = await this.EXPOSE_dm_Personal_WzDetails.FromSqlRaw(sqlQuery , p_OrderId ).ToListAsync();

            //Return
            return lst;
        }

        public void EXPOSE_dm_ScanningForAddingProduct(string SKU,string ProductName,string Gtin,int? SizeId,int? Amount,int? CategoryId)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_ScanningForAddingProduct] @SKU, @ProductName, @Gtin, @SizeId, @Amount, @CategoryId";
                //Execution
        ...
        public async Task<List<EXPOSE_dm_SearchingByNameCategoryAndSizeResult>> EXPOSE_dm_SearchingByNameCategoryAndSizeAsync(string ProductName,string CategoryName,string Size)
        {
            //Initialize Result 
            List<EXPOSE_dm_SearchingByNameCategoryAndSizeResult> lst = new List<EXPOSE_dm_SearchingByNameCategoryAndSizeResult>();
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_SearchingByNameCategoryAndSize] @ProductName, @CategoryName, @Size";
                
                //Output Data
                lst = await this.EXPOSE_dm_SearchingByNameCategoryAndSize.FromSqlRaw(sqlQuery , p_ProductName , p_CategoryName , p_Size ).ToListAsync();

            //Return
            return lst;
        }

        public async Task<List<EXPOSE_dm_Selecting_All_NewOrdersResult>> EXPOSE_dm_Selecting_All_NewOrdersAsync()
        {
            //Initialize Result 
            List<EXPOSE_dm_Selecting_All_NewOrdersResult> lst = new List<EXPOSE_dm_Selecting_All_NewOrdersResult>();


                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_Selecting_All_NewOrders] ";
                
                //Output Data
                lst = await this.EXPOSE_dm_Selecting_All_NewOrders.FromSqlRaw(sqlQuery ).ToListAsync();

            //Return
            return lst;
        }

        public async Task<List<EXPOSE_dm_SelectingALLFormAchievumResult>> EXPOSE_dm_SelectingALLFormAchievumAsync()
        {
            //Initialize Result 
            List<EXPOSE_dm_SelectingALLFormAchievumResult> lst = new List<EXPOSE_dm_SelectingALLFormAchievumResult>();


                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_SelectingALLFormAchievum] ";
                
                //Output Data
                lst = await this.EXPOSE_dm_SelectingALLFormAchievum.FromSqlRaw(sqlQuery ).ToListAsync();

            //Return
            return lst;
        }

        public async Task<List<EXPOSE_dm_SelectingCurrentOrderByStatusResult>> EXPOSE_dm_SelectingCurrentOrderByStatusAsync(int? OrderId)
        {
            //Initialize Result 
            List<EXPOSE_dm_SelectingCurrentOrderByStatusResult> lst = new List<EXPOSE_dm_SelectingCurrentOrderByStatusResult>();
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_SelectingCurrentOrderByStatus] @OrderId";
                
                //Output Data
                lst = await this.EXPOSE_dm_SelectingCurrentOrderByStatus.FromSqlRaw(sqlQuery , p_OrderId ).ToListAsync();

            //Return
            return lst;
        }

        public async Task<List<EXPOSE_dm_SelectingProductGtinResult>> EXPOSE_dm_SelectingProductGtinAsync(int? ProductId)
        {
            //Initialize Result 
            List<EXPOSE_dm_SelectingProductGtinResult> lst = new List<EXPOSE_dm_SelectingProductGtinResult>();
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_SelectingProductGtin] @ProductId";
                
                //Output Data
                lst = await this.EXPOSE_dm_SelectingProductGtin.FromSqlRaw(sqlQuery , p_ProductId ).ToListAsync();

            //Return
            return lst;
        }

        public async Task<List<EXPOSE_dm_SelectingProductsAfterScanningResult>> EXPOSE_dm_SelectingProductsAfterScanningAsync(int? OrderId)
        {
            //Initialize Result 
            List<EXPOSE_dm_SelectingProductsAfterScanningResult> lst = new List<EXPOSE_dm_SelectingProductsAfterScanningResult>();
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_SelectingProductsAfterScanning] @OrderId";
                
                //Output Data
                lst = await this.EXPOSE_dm_SelectingProductsAfterScanning.FromSqlRaw(sqlQuery , p_OrderId ).ToListAsync();

            //Return
            return lst;
        }

        public void EXPOSE_dm_Sending_Order_ToMagazyn(int? OrderProductId)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_Sending_Order_ToMagazyn] @OrderProductId";
                //Execution
        ...
        public void EXPOSE_dm_UpdatingWhileScanningBySKUCode(string SKU)
        {
                ...
                // Processing 
                string sqlQuery = $@"EXEC [dbo].[EXPOSE_dm_UpdatingWhileScanningBySKUCode] @SKU";
                //Execution
        ...
        public class EXPOSE_dm_DetailProductListStanMagazynuResult
        {
        ...
        public class EXPOSE_dm_ListOfWzOrders_InWZMAGAZYNResult
        {
        ...
        public class EXPOSE_dm_OpenningTheSpecificOrderResult
        {
            public string SKUnumber { get; set; }
            public string ProductName { get; set; }
            public string CategoryName { get; set; }
        ...
        public class EXPOSE_dm_OrderDetailResult
        {
            public string SKUnumber { get; set; }
            public string ProductName { get; set; }
            public string CategoryName { get; set; }
        ...
        public class EXPOSE_dm_Personal_WzDetailsResult
        {
            public int? Id { get; set; }
            public string ProductName { get; set; }
            public string Sender { get; set; }
        ...
        public class EXPOSE_dm_SearchingByNameCategoryAndSizeResult
        {
            public string ProductName { get; set; }
            public string CategoryName { get; set; }
            public string Size { get; set; }
        ...
        public class EXPOSE_dm_Selecting_All_NewOrdersResult
        {
        ...
        public class EXPOSE_dm_SelectingALLFormAchievumResult
        {
            public int? Id { get; set; }
            public DateTime? CreateAt { get; set; }
            public string Sender { get; set; }
        ...
        public class EXPOSE_dm_SelectingCurrentOrderByStatusResult
        {
            public string SKUnumber { get; set; }
            public string ProductName { get; set; }
            public string CategoryName { get; set; }
        ...
        public class EXPOSE_dm_SelectingProductGtinResult
        {
            public string ProductName { get; set; }
            public string Size { get; set; }
            public string CategoryName { get; set; }
        ...
        public class EXPOSE_dm_SelectingProductsAfterScanningResult
        {
            public string SKUnumber { get; set; }
            public string ProductName { get; set; }
            public string CategoryName { get; set; }
